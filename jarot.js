...
case 'tiktoknowm':
			...
			case 'tt':
				...
				let nih = ` 𝘕𝘪𝘩 𝘒𝘢𝘬 𝘔𝘢𝘥𝘦 𝘉𝘺 ${author} 𝘑𝘢𝘯𝘨𝘢𝘯 𝘓𝘶𝘱𝘢 𝘚𝘶𝘴𝘤𝘳𝘪𝘣𝘦 https://www.youtube.com/@salehdev8956`
				let buttons = [
	...
	const sections = [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "Thanks To ❤️",
										"description": "𝘑𝘢𝘯𝘨𝘢𝘯 𝘓𝘶𝘱𝘢 𝘚𝘶𝘴𝘤𝘳𝘪𝘣𝘦 𝘊𝘩𝘢𝘯𝘦𝘭 𝘚𝘢𝘭𝘦𝘩𝘋𝘦𝘷",
										"rowId": `${prefix}tqto`
									}
								]
							}
